...
from models.cross import ConcatMambaBlock
from models.cross import ChannelAwareVSSBlock
from models.fourier_modules import FrequencyAlignModule, DualBranchFusionBlock
...
class SS2D(nn.Module):
    ...
    def forward(self, x: torch.Tensor, **kwargs):
        ...
        #print(f"SS2D input shape: {x.shape}", flush=True)

        xz = self.in_proj(x)
        #print(f"SS2D in_proj output shape: {xz.shape}, in_proj weight shape: {self.in_proj.weight.shape}", flush=True)
